...
def get_atmos_pressure():
    '''
    TODO: Agregar PRES_BMP280 con valor 8 a
    https://github.com/niclabs/water-monitoring/blob/master/energy/coder/SensorPayload/dataTypes.h
    y a la tabla de
    https://github.com/niclabs/water-monitoring/blob/master/energy/decoder/ModuloDecodificacion.md
    '''
    sensor_id = 8 # Comparar con SensorPayload/dataTypes.h
    timestamp = int(time.time())
    value = bmp.pressure
    return (sensor_id, timestamp, value)
...
while True:
    ...
    if(recv_len > 0):
        ...
        # <Agregar presión atmosférica>
        # Leer la presión atmosférica desde acá (I2C de la LoPy, no del
        # Arduino)
        atmos_pressure_reading = get_atmos_pressure()
        # Agregar como un dato más a los datos decodificados
        decoded_data.append(atmos_pressure_reading)
        # </Agregar presión atmosférica>

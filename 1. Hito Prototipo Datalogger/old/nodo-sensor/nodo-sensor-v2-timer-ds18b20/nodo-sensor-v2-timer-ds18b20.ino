...
// Write data header.
void writeHeader() {
  String header_elem[DATA_COUNT+2] = {F("datetime"),F("unixtime"), F("dstemp")};
...
void writeData() {
  ...
  file.write(',');
  // Escritura del primer valor del arreglo
  file.print(data_buffer[0]);
  // Escritura de los siguientes valores del arreglo
  ...
  file.println();
  showMeasurement(data_buffer[0], unit, date_buf);
}
